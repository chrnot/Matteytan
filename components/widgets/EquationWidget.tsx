                ...
                <div className="w-full md:w-80 border-r border-slate-200 flex flex-col bg-white shadow-sm shrink-0 z-10">
                    {!isXSet ? (
                        <div className="p-8 flex-1 flex flex-col items-center justify-center text-center animate-in zoom-in duration-500">
                            ...
                            <button onClick={startAutoGame} className="w-full py-5 bg-indigo-900 text-white rounded-[2rem] font-black text-lg hover:bg-indigo-950 shadow-xl active:scale-95 transition-all flex items-center justify-center gap-3"><Icons.Shuffle className="text-amber-400" /> SLUMPA & STARTA</button>
                        </div>
                    ) : (
                        <div className="flex-1 flex flex-col overflow-hidden">
                            ...
                            <div className="p-5 border-t bg-white space-y-4 shrink-0 shadow-[0_-4px_12px_rgba(0,0,0,0.05)]">
                                <button onClick={() => setIsRevealed(true)} className="w-full py-4 bg-amber-400 text-amber-950 rounded-2xl font-black text-xs uppercase tracking-widest shadow-lg hover:bg-amber-500 transition-all flex items-center justify-center gap-2"><Icons.Hash size={16} /> AVSLÖJA x</button>
                            </div>
                        </div>
                    )}
                </div>
